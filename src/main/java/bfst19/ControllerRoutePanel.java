...
public class ControllerRoutePanel {
    ...
    private Vehicle previousVehicleToggle;
    private boolean previousFastestRoute;
    private String previousFromText;
    private String previousToText;
    ...
    private void tryToFindPath() {
        if (!textFieldFrom.getText().equals(previousFromText) || !textFieldTo.getText().equals(previousToText) || fastestRoute != previousFastestRoute || vehicleToggle != previousVehicleToggle) {
            previousToText = textFieldTo.getText();
            previousFromText = textFieldFrom.getText();
            previousFastestRoute = fastestRoute;
            previousVehicleToggle = vehicleToggle;
