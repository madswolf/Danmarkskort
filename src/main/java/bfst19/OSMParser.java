...
public class OSMParser {
    public static void parseOSM( InputStream osmsource, RouteHandler routeHandler, Model model,TextHandler textHandler, HashMap<WayType,ResizingArray<String[]>> wayTypeCases) throws XMLStreamException {
                    ...
                    switch (reader.getLocalName()) {
                        ...
                        case "tag":
                            ...
                            if(k.equals("source:maxspeed")){
                                if(v.equalsIgnoreCase("DK:urban")||v.equalsIgnoreCase("DK:city")||v.equalsIgnoreCase("DK:zone50")||v.equalsIgnoreCase("urban")) {
                                    speedlimit = 50;
